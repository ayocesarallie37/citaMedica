            ...
            <div class="col">
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input class="form-control" placeholder="Fecha de inicio" id="startDate" type="text" value="{{ $start }}">
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input class="form-control" placeholder="Fecha fin" id="endDate" type="text" value="{{ $end }}">
                    </div>
                </div>
            </div>
        </div>
